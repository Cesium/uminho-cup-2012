...
find_team("Sei Lá") do |team|
  add_player team, "João Carlos", "Alves da Cruz"
  add_player team, "Tiago André", "Cruz Ferreira"
  add_player team, "Hélder Cristiano", "Dias Afonso"
  add_player team, "Fábio André" , "Martins Fernandes"
  add_player team, "Jorge Miguel", "Barreiro Ferreira"
  add_player team, "Tiago Filipe", "Martins Moreira "
  add_player team, "João" , "Esteves"
  add_player team, "Luís Miguel" , "Barbosa Barreiro"
end